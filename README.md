...
I learned a lot about using express.js routes during this project, as well as how the front-end and the back end communicate with each other. THIS REPOSITORY IS A RE-CREATION OF A PREVIOUS REPOSITORY. FOR ACCURATE RECORD OF PREVIOUS COMMITS, VISIT 
